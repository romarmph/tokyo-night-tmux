...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=${THEME[foreground]},bg=${THEME[background]},nobold] #{?client_prefix,󰠠 ,#[dim]󰤂 }#[nobold,nodim]#S "

#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "$RESET#[fg=${THEME[green]},bg=${THEME[bblack]}] #{?#{==:#{pane_current_command},ssh},󰣀,} #[fg=${THEME[foreground]},nobold,nodim]$window_number #W#[nobold]#{?window_zoomed_flag, $zoom_number, $custom_pane} #{?window_last_flag,,} "
# Unfocused
